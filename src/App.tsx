            ...
            <main className="bg-gray-50">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="space-y-4">
                  ...
                  {/* Sous-traitants - Visible uniquement pour ADMIN_FULL et COMPTABLE */}
                  {can('viewConsignments', userRole) && (
                    <div className="bg-white/90 rounded-xl shadow-sm border border-gray-200/50 overflow-hidden">
                      <button
                        onClick={() => {
                          console.log('[Dashboard] Navigation vers consignments');
                          setCurrentPage('consignments');
                        }}
                        aria-label="Section Sous-traitants"
