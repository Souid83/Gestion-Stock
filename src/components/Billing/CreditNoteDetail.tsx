  ...
  const fetchCreditNote = async () => {
    ...
    try {
      ...
      const { data: creditNoteData, error: creditNoteError } = await supabase
        .from('credit_notes_with_customer')
        .select('*')
        .eq('id', creditNoteId)
        .single();
      ...
      <div ref={creditNoteRef} className="bg-white rounded-lg shadow p-8 max-w-4xl mx-auto">
        ...
        <div className="flex justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Facture: {creditNote.invoice_number}</p>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="border-t border-gray-200 pt-2">
            ...
            {creditNote.customer_email && <p>{creditNote.customer_email}</p>}
            {creditNote.customer_phone && <p>{creditNote.customer_phone}</p>}
          </div>
        </div>
